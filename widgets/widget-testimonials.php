 ...
 *
 * This widget is for positioning/removing the "Testimonials" block on BookIt pages.
...
class ProGo_Widget_Testimonials extends WP_Widget {
	...
	function ProGo_Widget_Testimonials() {
		...
		$widget_ops = array( 'classname' => 'test', 'description' => __( 'BookIt page\'s Testimonial ', $this->textdomain ) );
